...
def main():
    ...
    def write_to_pickle(url_file, out_file, chunk_size=1000):
        ...
        story_fnames = ["../data/cnn_stories_tokenized/" + s + ".story"
                        if u.find('cnn.com') >= 0 else "../data/cnn_dm_stories/dm_stories_tokenized/" + s + ".story"
                        for u, s in url]
    ...
    if not os.path.exists("../data/CNN_DM_pickle_data/chunked"):
        os.mkdir("../data/CNN_DM_pickle_data/chunked")
